...
const filter = () => {
  return (
    <div className="w-screen h-screen flex justify-center items-center relative top-16">
      ...
      <div className="absolute top-[30%]  w-[300px] h-[500px] left-1/2 -translate-x-1/2 bg-white rounded-lg shadow-[0_-4px_10px_rgba(0,0,0,0.2)] z-20 flex items-center justify-center">
      </div>
